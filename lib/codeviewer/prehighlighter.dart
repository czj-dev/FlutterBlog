...
class DartSyntaxPrehighlighter extends SyntaxHighlighter {
  final CodeStyle _codeStyle;

  DartSyntaxPrehighlighter(this._codeStyle) {
...
class CodeSpan extends TextSpan {
  CodeSpan(this.codeStyle, {this.type = _HighlightType.base, this.text})
      : super(style: _styleNameOf(type, codeStyle), text: _escape(text));
